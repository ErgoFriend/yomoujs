...
function GetGenre() {
    return {
        bigGenre: config_1.config.bigGenre,
        Genre: config_1.config.Genre
    };
}
exports.GetGenre = GetGenre;
// 大ジャンル
function BigGenreName(number) {
    let big_genre_name;
    switch (number) {
...
exports.BigGenreName = BigGenreName;
function BigGenreNumber(string) {
...
exports.BigGenreNumber = BigGenreNumber;
//ジャンル
function GenreName(number) {
    let genre_name;
    switch (number) {
        //  恋愛
        case 101:
...
exports.GenreName = GenreName;
function GenreNumber(string) {
    let genre_number;
    switch (string) {
        //  恋愛
        case "異世界":
...
exports.GenreNumber = GenreNumber;
